...
print('test_labels.len: {}'.format(len(test_labels)))
...
def scan_train_image():
    plt.figure()
    plt.imshow(train_images[0])
    plt.colorbar()
    plt.grid(False)
    plt.savefig(os.path.join(OUTPUT_DIR, 'scan.png'))


def preview_train_images():
